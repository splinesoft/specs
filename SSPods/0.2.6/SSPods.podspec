Pod::Spec.new do |s|
  ...
  s.frameworks = 'UIKit', 'QuartzCore', 'AudioToolbox', 'Social'
  ...
  #  sp.frameworks = 'Social'
  #  sp.source_files = 'Controllers/*.{h,m}'
  #end
  
  s.subspec 'Styles' do |sp|
    sp.source_files = 'Styles/*.{h,m}'
  end
  ...
  #  sp.dependency 'SSPods/Controllers'
    sp.dependency 'SSPods/Styles'
  end
